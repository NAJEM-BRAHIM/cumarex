...
class HrVersion(models.Model):
    ...
    l10n_ma_taux_frais_pro = fields.Selection(
        ...
        default='20',
        help="20% standard (plafond 2.500 DH/mois). 35% pour salaires ≤ 78.000 DH/an, 25% au-delà (plafond 35.000 DH/an)."
    )

    l10n_ma_calc_ir = fields.Boolean(
        string="Calculer IR",
        default=True,
        help="Activer/désactiver le calcul de l'Impôt sur le Revenu pour cet employé."
    )

    l10n_ma_calc_amo = fields.Boolean(
        string="Calculer AMO",
        default=True,
        help="Activer/désactiver le calcul de l'AMO pour cet employé."
    )
